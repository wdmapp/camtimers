...
#define gptlrecord                  FCI_GLOBAL(gptlrecord,GPTLRECORD)
...
#define gptlstart_virtual           FCI_GLOBAL(gptlstart_virtual,GPTLSTART_VIRTUAL)
#define gptlstart_handle            FCI_GLOBAL(gptlstart_handle,GPTLSTART_HANDLE)
#define gptlstop                    FCI_GLOBAL(gptlstop,GPTLSTOP)
#define gptlstop_virtual            FCI_GLOBAL(gptlstop_virtual,GPTLSTOP_VIRTUAL)
...
int gptlrecord (char *name, int *threadid, int *count_incr, double *time_incr,
		double *max_upd, double *min_upd, int nc1);
int gptlreset (void);
int gptlstamp (double *wall, double *usr, double *sys);
int gptlstart (char *name, int nc1);
int gptlstart_virtual (char *name, int *threadid, int nc1);
int gptlstart_handle (char *name, void **, int nc1);
int gptlstop (char *name, int nc1);
int gptlstop_virtual (char *name, int *threadid, int nc1);
...
int gptlrecord (char *name, int *threadid, int *count_incr, double *time_incr,
		double *max_upd, double *min_upd, int nc1)
{
  return GPTLrecordf (name, threadid, count_incr, time_incr, max_upd, min_upd, nc1);
}
...
int gptlstart_virtual (char *name, int *threadid, int nc1)
{
  return GPTLstartf_virtual (name, threadid, nc1);
}
...
int gptlstop_virtual (char *name, int *threadid, int nc1)
{
  return GPTLstopf_virtual (name, threadid, nc1);
}
